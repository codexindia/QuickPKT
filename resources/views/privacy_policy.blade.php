...
<body>
    <div class=" p-6 bg-white border border-gray-200 rounded-lg shadow">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to Quick PKT.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to Quick PKT, accessible from <a href="Quickpkt.in"
                        rel="external nofollow noopener" target="_blank">Quickpkt.in</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: support@quickpkt.in</li>
        </ul>
    </div>
</body>
